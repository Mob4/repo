         ...
         ++i)
    {
        ...
        if(item->type() == ANIMNODE_ELLIPSE_TYPE)
        {
            ...
            if ((center.x() == line().x1()) && (center.y() == line().y1()))
            {
                ...
                painter->setBrush(br);
                /*if (m_pointBDescription)
                    painter->drawText(l.p2(), *m_pointBDescription);*/
            ...
            else
            {
                ...
                painter->setBrush(br);
                /*if (m_pointADescription)
                    painter->drawText(l.p2(), *m_pointADescription);*/
                painter->drawEllipse(l.p2(), radius/4, radius/4);
                m_interfacePosA = l.p2();
                painter->restore();
...
{
    AnimLink * theLink = 0;
    for(LinkManager::AnimLinkVector_t::const_iterator i = m_pointToPointLinks.begin();
