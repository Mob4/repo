...
private:
  ...
  /**
   * Added by FD for compilation in NS3.15
   */
...
private:
  ...
  TracedCallback<Ptr<const Packet>, Ptr<const PhySimWifiPhyTag> > m_energyDetectionFailed;
    ...
    // Adding trace to signal CCA Busy start mainly for startReceive based on CheckForNextCcaBusyStart
  TracedCallback<Ptr<const Packet>, Ptr<const PhySimWifiPhyTag>, enum PhySimWifiPhy::ErrorReason > m_receptionNextCcaBusy ;
