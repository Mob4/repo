...
public:
  ...
  /*BH*/// Get messages counters
  uint32_t GetHelloSnt () const { return m_helloSnt; };
  uint32_t GetRRquSnt () const { return m_rrquSnt; };
  uint32_t GetRRepSnt () const { return m_rrepSnt; };
  uint32_t GetRErrSnt () const { return m_rerrSnt; };
  uint32_t GetHelloRcv () const { return m_helloRcv; };
  uint32_t GetRRquRcv () const { return m_rrquRcv; };
  uint32_t GetRRepRcv () const { return m_rrepRcv; };
  uint32_t GetRErrRcv () const { return m_rerrRcv; };
  uint32_t GetDeferRt () const { return m_deferRt; };
  RequestQueue GetQueue () const { return m_queue; };
