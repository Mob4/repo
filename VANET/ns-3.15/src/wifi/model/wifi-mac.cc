...
NS_OBJECT_ENSURE_REGISTERED (WifiMac);
  ...
  /** CLWPR => added for CLWPR */
  uint64_t 
  WifiMac::GetTxBytes (void)
  {
    return m_macTxBytes;
  }
  /* CLWPR end of modification */
...
WifiMac::Configure80211_10Mhz (void)
{
  ...
  // BH - Making longer for compatibility with Physim when RTS/CTS is used
  SetCtsTimeout (MicroSeconds (32 + 88 + 13 + 40 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2));
