...
public:
  ...
  /**
   * For CLWPR modification and adaptation to ns-3.15
   */
  uint64_t GetTxBytes (void) ;
...
private:
  ...
  /**
   * CLWPR modification: A counter of all TxBytes that come into the "top" of the device
   * at the L3/L2 transition, before being queued for transmission.
   *
   */
  uint64_t m_macTxBytes;
