 ...
 */
#ifndef CLWPR_RQUEUE_H
#define CLWPR_RQUEUE_H
...
/**
 * \ingroup clwpr
 * \brief CLWPR route request queue
 * 
 * Since CLWPR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
  ...
  //\}
  std::vector<QueueEntry> GetQueue(){ return m_rqueue;}

private:
  std::vector<QueueEntry> m_rqueue;
