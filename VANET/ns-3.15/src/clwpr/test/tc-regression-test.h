...
/**
 * \ingroup clwpr
 * \brief Less trivial test of CLWPR Topology Control message generation
 * 
 * This test creates 3 WiFi stations with chain topology and runs CLWPR without any extra traffic. 
